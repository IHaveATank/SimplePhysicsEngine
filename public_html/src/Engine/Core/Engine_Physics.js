...
gEngine.Physics = (function () {
    ...
    var resolveCollision = function (s1, s2, collisionInfo) {
        ...
        var s1V = s1.mVelocity;
        var s2V = s2.mVelocity;
        var n = collisionInfo.getNormal();
        _applyFriction(n, s1V, s1.mFriction, s1.mInvMass);
        _applyFriction(n, s2V, -s2.mFriction, s2.mInvMass);
        ...
        var newImpulse = [0, 0];
        vec2.scale(newImpulse, impulse, s1.mInvMass);
        vec2.sub(s1V, s1V, newImpulse);

        vec2.scale(newImpulse, impulse, s2.mInvMass);
