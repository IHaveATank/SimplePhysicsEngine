...
function ScaleObject(shader, name, xPivot, yPivot) {
    ...
    xf = obj.getXform();
    xf.setSize(0.5, 0.5);
    xf.setPosition(xPivot - 3, yPivot); 
...
gEngine.Core.inheritPrototype(ScaleObject, SceneNode);

ScaleObject.prototype.update = function () {
